  ...
  return (
    <Sidebar>
      <SidebarHeader className="px-6 py-4 border-b bg-white shadow-sm">
        ...
        {isMobile && (
          <div className="flex flex-col gap-3 mt-4 pb-2 border-gray-200">
            <Button variant="outline" className="w-full justify-start border-gray-200 bg-gray-50 hover:bg-blue-50 hover:border-blue-200 text-gray-700 hover:text-blue-700 shadow-sm transition-all duration-200" size="lg">
            ...
            <Button variant="outline" className="w-full justify-start border-gray-200 bg-gray-50 hover:bg-blue-50 hover:border-blue-200 text-gray-700 hover:text-blue-700 shadow-sm transition-all duration-200" size="lg">
              ...
              <SidebarContent>
          <ScrollArea className="flex-1" style={{ height: isMobile ? "calc(100vh - 160px)" : "calc(100vh - 160px)" }}>
